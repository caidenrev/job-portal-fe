            ...
            <form onSubmit={handleSubmit} className="space-y-8 bg-background/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-border/50 shadow-sm shadow-primary/5">
                ...
                <div className="grid gap-8 sm:grid-cols-2">
                    <div className="space-y-3">
                        ...
                        <Input id="title" placeholder="Cth: Frontend Developer" required className="h-12 border-primary/20 focus-visible:ring-primary/30 shadow-sm bg-background/80" />
                    </div>
                ...
                <div className="space-y-3">
                    ...
                    <Input id="location" placeholder="Cth: Jakarta Selatan (Remote / WFO)" required className="h-12 border-primary/20 focus-visible:ring-primary/30 shadow-sm bg-background/80" />
                </div>
                ...
                <div className="pt-4 flex justify-end">
                    <Button type="submit" size="lg" className="w-full sm:w-auto font-semibold shadow-md shadow-primary/20 h-12 px-8 transition-transform hover:scale-[1.02]">
